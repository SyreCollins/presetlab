...
const plans = [
  {
    ...
    icon: Zap,
    features: ["10 presets per month", "Email support", "HD quality exports", "Basic templates", "Lightroom XMP format"],
    popular: false,
  },
  {
    id: "pro",
    ...
    icon: Star,
    features: ["25 presets per month", "Priority support", "4K quality exports", "Custom branding", "Advanced templates", "Multiple formats"],
    popular: true,
  },
  {
    id: "premium",
